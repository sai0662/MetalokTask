...
<Text style={styles.codeTxt}>n5mge7asd11bfsp24knktn89sd1k3sdnk</Text>
</View>
        ...
        <Text style={styles.solValueTxt}>50 SOL</Text>
        </View>
        </View>
        <Text style={styles.noteTxt}>Note</Text>
        <View style={styles.firstInputView}>
         <View style={styles.amountInput}>
 <Text style={styles.noteText}>NFT Payment to GorillaFX</Text>
 </View> 
        </View>
    ...
    <TouchableOpacity style={styles.bottomButtonView} onPress={() => navigation.navigate('Convert')}>
